...
namespace simplifier
{
    class MathExtended
    {
        ...
        /// <summary>
        /// Polinomokaat össeadni tudó függvény.
        /// </summary>
        /// <param name="a"></param>
        /// <param name="b"></param>
        /// <param name="sign_a"></param>
        /// <param name="sign_b"></param>
        /// <returns></returns>
        public static double[] PolySum(double[] a, double[] b, int sign_a, int sign_b)
        {
            if (a.Length > b.Length)
                b = ResizeArray(b, a.Length, true);
            else
        ...
        {
            Console.WriteLine("display a vector: \n\t");
        ...
        {
            Console.WriteLine("display a vector, which name is: {0}\n\t", name);
            foreach (double element in vector)
            {
                Console.Write("  {0}  ", element);
            }
